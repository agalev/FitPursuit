...
import CompetitionsTable from './components/competitions_table'
...
export default function Home() {
	...
	return (
		<main>
			...
			<div className='flex justify-center '>
				...
				<div className='mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]'>
					<input
						...
						id='inlineRadio3'
						value='teams'
						checked={activeTab === 'competitions'}
						onChange={() => setActiveTab('competitions')}
					/>
					<label
						className='mt-px inline-block pl-[0.15rem] hover:cursor-pointer'
				...
				<div className='mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]'>
					<input
						...
						id='inlineRadio4'
						value='activities'
						checked={activeTab === 'activities'}
						onChange={() => setActiveTab('activities')}
					/>
					<label
						className='mt-px inline-block pl-[0.15rem] hover:cursor-pointer'
			...
			{activeTab === 'activities' && <ActivitiesTable param='all' />}
		</main>
	)
}
